...
public class Main {
	...
	public static void main(String[] args) throws IOException{
		...
		boolean print = false; //si true, affiche les résultats au fur et à mesure
		boolean timeGraph = true; //si true, fait le graphe du temps d'exécution. Sinon, fait le graphe du nombre d'états visités.
		int iter = 10; //nombre d'itérations pour moyenner le temps
